...
class Address {
    ...
    public static Map<String, List<Address>> generateCityAddressMap(Map<String, List<Address>> cityAddressMap, Address address) {
        if (!cityAddressMap.containsKey(address.getCity())) {
            cityAddressMap.put(address.getCity(), new ArrayList<Address>());
        }
